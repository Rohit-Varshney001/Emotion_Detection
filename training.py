...
train_data_dir= r'C:\Users\kushw\PycharmProjects\EMOTION\FER2013\train'
validation_data_dir = r'C:\Users\kushw\PycharmProjects\EMOTION\FER2013\test'
...
validation_generator = validation_datagen.flow_from_directory(train_data_dir,color_mode='grayscale',
                                                   target_size=(img_rows,img_cols),batch_size=batch_size,
                                                   class_mode='categorical', shuffle=True)
...
checkpoint = ModelCheckpoint(r'C:\Users\kushw\PycharmProjects\EMOTION\Emotion_little_vgg.h5',
                             monitor='val_loss',
                             mode='min',
                             save_best_only=True,
                             verbose=1)
